    ...
    <nav
      ...
      <div class="h-full grid grid-cols-3 text-center">
        <router-link
          ...
          ">
          <span
            class="mb-2 w-7 h-7 rounded-xl bg-blue-50 dark:bg-blue-900/50 flex items-center justify-center shadow-inner">
            📋
          </span>
          작업목록
          <span
            v-if="$route.name === 'MobileJobs'"
            class="absolute -top-0.5 w-15 h-1 rounded-full bg-blue-600/80 dark:bg-blue-400/80"></span>
        </router-link>
        <router-link
        ...
        <router-link
          ...
          ">
          <span
            class="mb-2 w-7 h-7 rounded-xl bg-green-50 dark:bg-green-900/50 flex items-center justify-center shadow-inner">
            💰
          </span>
          정산내역
          <span
