<template>
  <div class="w-full dark:black p-4">
    <!-- 상단 정산 요약 카드 -->
    <div class="mb-4">
      <div
    ...
    <div class="space-y-3">
      <div
        v-for="payment in filterdPayment"
        :key="payment.id"
        class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 dark:text-gray-300 rounded-2xl p-4 shadow-sm">
        <!-- 날짜와 상태 -->
