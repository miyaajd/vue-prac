    ...
    >
      <div class="flex flex-col h-full">
        ...
        <div class="p-4 border-t border-gray-200 dark:border-gray-700">
          <button
            @click="logout"
            class="cursor-pointer w-full flex items-center justify-center px-4 py-2 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
          >
...
const links = [
  ...
  {
    name: "고객 소통",
    path: "/admin/customer-communication",
